...
1. Change LEC to "In-person", etc.

    Where we used to provide "Instructional Method", we now need to give
    "Delivery Mode".  The options here are In-person, Online, and Hybrid.
    You may find it handy to edit all these in the CSV -- especially if they
    are all the same for your department/program.
